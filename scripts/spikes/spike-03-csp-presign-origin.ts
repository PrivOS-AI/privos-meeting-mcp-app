 ...
 * docs/system-architecture.md § Spike results. Requires: PRIVOS_FILES_ORIGIN.
 */
const REQUIRED: string[] = ['PRIVOS_FILES_ORIGIN'];

function main(): void {
  console.log('SPIKE: CSP + presigned Files origin');
